...
model: haiku  # Grep-based filtering + frontmatter scanning — no heavy reasoning needed
---
...
- `/clavain:flux-drive` - To review plans/documents with targeted agent triage
