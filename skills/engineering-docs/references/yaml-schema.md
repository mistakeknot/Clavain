...
**See `skills/engineering-docs/schema.yaml` for the complete schema specification.**
...
- **component** (enum): One of [model, controller, view, service_object, background_job, database, frontend, api, cli, tui, authentication, integration, development_workflow, testing_framework, documentation, tooling]
...
- **framework_version** (string): Framework/language version in X.Y.Z format
...
component: model
symptoms:
  - "N+1 query when loading related records"
  - "Data generation taking >5 seconds"
