...
component: [model|controller|view|service_object|background_job|database|frontend|api|cli|tui|authentication|integration]
symptoms:
...
framework_version: [e.g., 1.22.0 - optional]
...
- Framework Version: [e.g., 1.22.0]
- Affected Component: [e.g., "Data processing model", "API service", "Authentication controller"]
