...
digraph process {
    ...
    "Use clavain:landing-a-change" [shape=box style=filled fillcolor=lightgreen];
    ...
    "Dispatch final code reviewer subagent for entire implementation" -> "Use clavain:landing-a-change";
}
```
...
- **clavain:interserve** - Use Codex agents for parallel implementation when tasks
