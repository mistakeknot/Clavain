...
description: Engine for /clavain:upstream-sync — checks beads/oracle/superpowers/compound-engineering for updates, generates upgrade checklist. Internal; invoke via slash command.
---
