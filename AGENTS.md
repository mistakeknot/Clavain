...
| Components | 26 skills, 6 agents, 57 commands, 17 hooks, 0 MCP servers |
| License | MIT |
...
```bash
echo "Skills: $(ls skills/*/SKILL.md | wc -l)"      # Should be 26
echo "Commands: $(ls commands/*.md | wc -l)"        # Should be 57
```
