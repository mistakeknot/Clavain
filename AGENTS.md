...
| Components | 20 skills, 6 agents, 56 commands, 15 hooks, 0 MCP servers |
| License | MIT |
...
```bash
echo "Skills: $(ls skills/*/SKILL.md | wc -l)"      # Should be 20
echo "Commands: $(ls commands/*.md | wc -l)"        # Should be 56
```
