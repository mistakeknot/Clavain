...
General-purpose engineering discipline plugin for Claude Code — 27 skills, 5 agents, 36 commands, 7 hooks, 1 MCP servers. Companions: `interphase` (phase tracking, gates, discovery), `interline` (statusline renderer), `interflux` (multi-agent review + research engine).
