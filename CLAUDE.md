...
General-purpose engineering discipline plugin for Claude Code — 29 skills, 17 agents, 37 commands, 5 hooks, 2 MCP servers. Companions: `interphase` (phase tracking, gates, discovery), `interline` (statusline renderer).
