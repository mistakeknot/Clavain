...
|------|-------|---------|---------|
| **Skills** | 19 | Reusable discipline knowledge | `systematic-debugging`, `writing-plans`, `flux-drive` |
| **Agents** | 6 | Autonomous specialists (review + workflow) | `plan-reviewer`, `pr-comment-resolver` |
| **Commands** | 55 | User-invocable entry points | `/sprint`, `/interpeer`, `/write-plan` |
