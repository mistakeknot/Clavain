...
- **Location:** `os/clavain/docs/vision.md` — self-improvement section; `infra/intercore/docs/product/intercore-vision.md` — Interspect integration
...
- **Location:** `infra/intercore/docs/product/intercore-vision.md` — Process Model section; `os/clavain/docs/vision.md` — Track A roadmap
...
- **Location:** `infra/intercore/docs/product/intercore-vision.md` — Gates section; `os/clavain/docs/vision.md` — autonomy model
...
- **Location:** `os/clavain/docs/vision.md` — Discovery → Backlog Pipeline, confidence-tiered autonomy
...
- **Location:** `infra/intercore/docs/product/intercore-vision.md` — Gates, dispatch completion; `os/clavain/docs/vision.md` — Level 2 autonomy
...
- **Location:** `infra/intercore/docs/product/autarch-vision.md` — "The Four Tools" section; `os/clavain/docs/vision.md` — Architecture
...
- **Location:** `os/clavain/docs/vision.md` — "What Clavain Is Not" section, line 403
...
- **Location:** `os/clavain/docs/vision.md` — Discovery → Backlog Pipeline, adaptive thresholds
