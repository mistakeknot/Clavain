...
## Part 1: Agent Smoke Tests (16 agents, all in parallel)

Launch ALL 16 agents in parallel using the Task tool with `run_in_background: true`. Use `model: haiku` and `max_turns: 3` for each.
...
### Agent 10: best-practices-researcher
...
### Agent 11: framework-docs-researcher
...
### Agent 14: repo-research-analyst
...
### Agent 16: bug-reproduction-validator
...
After ALL 16 agents have completed and you've collected their results, run these 5 command tests sequentially using the Skill tool.
...
### Workflow 22: Review pipeline wiring
- Source: Command 21 (quality-gates) output
...
### Workflow 23: Explore pipeline wiring
- Source: Command 20 (brainstorm) output
...
### Workflow 24: Help catalog completeness
- Source: Command 17 (help) output
...
Output a markdown results table with all 24 tests:
...
| 10 | best-practices-researcher | agent | PASS/FAIL | [brief] |
| 11 | framework-docs-researcher | agent | PASS/FAIL | [brief] |
| 12 | git-history-analyzer | agent | PASS/FAIL | [brief] |
| 13 | learnings-researcher | agent | PASS/FAIL | [brief] |
| 14 | repo-research-analyst | agent | PASS/FAIL | [brief] |
| 15 | pr-comment-resolver | agent | PASS/FAIL | [brief] |
| 16 | bug-reproduction-validator | agent | PASS/FAIL | [brief] |
| 17 | help | command | PASS/FAIL | [brief] |
| 18 | doctor | command | PASS/FAIL | [brief] |
| 19 | changelog | command | PASS/FAIL | [brief] |
| 20 | brainstorm | command | PASS/FAIL | [brief] |
| 21 | quality-gates | command | PASS/FAIL | [brief] |
| 22 | review-pipeline | workflow | PASS/FAIL | [brief] |
| 23 | explore-pipeline | workflow | PASS/FAIL | [brief] |
| 24 | help-catalog | workflow | PASS/FAIL | [brief] |
...
If all 24 passed, end with: "All smoke tests passed."
