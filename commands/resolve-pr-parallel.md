...
- Commit changes
- Push to remote
- Use `gh api` to resolve PR review threads if applicable

Last, check `gh pr view PR_NUMBER --comments` again to see if all comments are resolved. They should be, if not, repeat the process from step 1.
