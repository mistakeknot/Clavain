...
Use the `clavain:codex-first` command content — same behavioral contract, same toggle logic, same CLAUDE.md auto-detection. The only difference is the shorter name.
