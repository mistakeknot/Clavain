...
2. **fd-architecture** — Use the Task tool with `subagent_type: "clavain:review:fd-architecture"` to evaluate architectural decisions, component boundaries, and design patterns.

3. **fd-quality** — Use the Task tool with `subagent_type: "clavain:review:fd-quality"` to check for over-engineering, unnecessary complexity, and YAGNI violations.
