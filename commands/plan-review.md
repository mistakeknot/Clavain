...
2. **architecture-strategist** — Use the Task tool with `subagent_type: "clavain:review:architecture-strategist"` to evaluate architectural decisions, component boundaries, and design patterns.

3. **code-simplicity-reviewer** — Use the Task tool with `subagent_type: "clavain:review:code-simplicity-reviewer"` to check for over-engineering, unnecessary complexity, and YAGNI violations.
